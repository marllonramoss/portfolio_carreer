...
import { frontendSkills, backendSkills, designSkills, additionalSkills } from "@/lib/skills-data";

const SkillBar = ({ skill, level, label, delay = 0 }: { skill: string; level: number; label: string; delay?: number }) => {
  return (
    <motion.li
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-zinc-300 max-w-2xl mx-auto">
            My technical toolbox combines both frontend and backend technologies with a focus on modern, scalable solutions.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-xl font-display font-bold text-zinc-100">FRONTEND</h3>
            </div>
          ...
          >
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-xl font-display font-bold text-zinc-100">BACKEND</h3>
            </div>
          ...
          >
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-xl font-display font-bold text-zinc-100">DESIGN</h3>
            </div>
        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4">
            {additionalSkills.map((skill, index) => (
              ...
              >
                <i className={`${skill.icon} text-purple-600 text-2xl mb-3`}></i>
                <span className="font-mono text-sm text-zinc-300 block">{skill.name}</span>
              </motion.div>
            ))}
          </div>
        </div>
